...
# Step c: Create a dictionary named workout_stats with friend names (keys) and workout minutes as tuples (values)
workout_stats = {
    "Alex": (30, 45, 20),
    "Jamie": (25,50,15), 
    "Taylor": (40,30,15)
}
# Step d: Loop calculating the total workout
...
# e. 2D list (nested list) containing workout minutes for each friend
workout_list = []
...
# i. Find friend with highest and lowest total workout minutes
highest_total = 0
